...
class ArtistPlaylistFragment : Fragment() {
    ...
    private val songViewModel: SongViewModel by activityViewModels { com.example.nct_lite.viewmodel.song.SongViewModelFactory(com.example.nct_lite.data.song.SongRepository()) }
