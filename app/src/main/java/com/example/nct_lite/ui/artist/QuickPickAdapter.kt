...
class QuickPickAdapter(
    ...
    inner class SongViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        private val title: TextView = itemView.findViewById(R.id.text_quick_title)
        private val artist: TextView = itemView.findViewById(R.id.text_quick_artist)
        private val cover: ImageView = itemView.findViewById(R.id.image_quick_pick)
